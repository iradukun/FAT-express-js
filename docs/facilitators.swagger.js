 ...
 * tags:
 *   - name: Facilitators
 *     description: Facilitator management endpoints
 * 
 * /api/facilitators:
 *   get:
 *     tags: [Facilitators]
 *     summary: Get all facilitators with pagination and filtering
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *               $ref: '#/components/schemas/Success'
 *       400:
 *         description: Cannot delete facilitator with active course assignments
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Error'
 ...
 *         $ref: '#/components/responses/Forbidden'
 * 
 * /api/facilitators/{id}/assignments:
 *   get:
 *     tags: [Facilitators]
 *     summary: Get facilitator's course assignments
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     responses:
 *       200:
 *         description: Facilitator assignments retrieved successfully
 *         content:
 *           application/json:
 *             schema:
 *               allOf:
